                  ...
                  <div class="block-content">
                    <div class="p-sm-3 px-lg-4 px-xxl-5 py-lg-5">
                      ...
                      <form class="js-validation-signin" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="py-3">
                          <div class="mb-4">
                            <input type="email" class="form-control form-control-alt form-control-lg" id="login-username" name="email" :value="old('email')" placeholder="User Email">
                            <x-input-error :messages="$errors->get('email')" class="mt-2" />
                          </div>
                          <div class="mb-4">
                            <input type="password" class="form-control form-control-alt form-control-lg" id="login-password" name="password" placeholder="Password" autocomplete="current-password">
