                      ...
                      <form class="js-validation-signup" action="{{ route('register') }}" method="POST">
                        ...
                        <div class="py-3">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg form-control-alt" id="signup-username" name="name" :value="old('name')" placeholder="Username" required autofocus autocomplete="username">
                                <x-input-error :messages="$errors->get('name')" class="mt-2" />
                            </div>

                            <div class="mb-4">
                                <label for="signup-email" class="form-label">Email</label>
                                <input type="email" class="form-control form-control-lg form-control-alt" id="signup-email" name="email" :value="old('email')" placeholder="Email" required autocomplete="email">
                                <x-input-error :messages="$errors->get('email')" class="mt-2" />
                            </div>

                            <div class="mb-4">
                                <label for="signup-password" class="form-label">Password</label>
                                <input type="password" class="form-control form-control-lg form-control-alt" id="signup-password" name="password" placeholder="Password" required autocomplete="new-password">
